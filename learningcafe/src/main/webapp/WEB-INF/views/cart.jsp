			...
			<table id="cart" class="table table-hover table-condensed">
						...
						<tr>
							<td data-th="Product">
								<div class="row ">
									...
									<div class="col-sm-10 ">
										<h4 class="w3-margin">${cartLine.product.name}
											<c:if test="${cartLine.available == false}">
												<strong style="color: red">(Not Available)</strong>
											</c:if>
										</h4>
										<p class="w3-margin">Brand : ${cartLine.product.brand}</p>
										<p class="w3-margin">Description :
				...
				<tfoot>
					...
					<tr>
						...
						<td class="hidden-xs text-right"><strong>Total
								&#8377; ${userModel.cart.grantTotal}/-</strong></td>
